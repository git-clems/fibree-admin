        ...
        <Link to={`/evenement/${event._id}`} className="hover:bg-gray-200 flex flew-wrap border-t-1 overflow-hidden border-gray-300 flex-1 p-2">
            ...
            <div className="flex-1 ml-2">
                ...
                <div className='flex max-[600px]:hidden justify-between mt-1 flex-wrap'>
                    {event.comingDate && <div className='text-xs mt-1 font-bold text-white truncate bg-red-500 rounded p-1 '> <i className='fa-solid fa-calendar'></i> {PublishTime(Timestamp.fromDate(new Date(`${event?.comingDate}T${event?.comingTime}`)))} GMT</div>}
