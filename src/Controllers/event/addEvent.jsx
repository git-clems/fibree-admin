                        ...
                        <div class="m-2 p-2 max-h-[70vh] overflow-auto">
                            ...
                            <div className='flex justify-between flex-wrap'>
                                <div className="mt-4 m-1 flex-1 min-w-[300px]">
                                    ...
                                    {
                                        typeCheck ?
                                            <input type='text' onChange={inputHandler} className="form-control" name='type' rows="3" placeholder="Ex: Forum"></input> :
                            ...
                            <div class="mt-4 m-1">
                                ...
                                <div className='flex'>
                                    ...
                                    <input style={{ borderTopLeftRadius: 0, borderBottomLeftRadius: 0 }} type="time" onChange={inputHandler} name='comingTime' class="form-control" placeholder="" />
                                </div>
                            </div>
                            ...
                            <div className="min-w-[300px] mt-4 m-1 flex-1">
                                ...
                                <div className="flex mt-4 m-1 items-start">
                                    <input className="form-check-input mt-1" type="checkbox" name='online' onChange={inputHandler} />
                            ...
                            <div class="mt-4 m-1">
                                ...
                                <input type="url" onChange={inputHandler} name='link' class="form-control" placeholder="Lien de l'évènement" />
                            </div>
                            <div class="mt-4 m-1">
                                <label for="" class="form-label">Message associé au lien de l'évènement</label>
                                <input type="text" onChange={inputHandler} name='linkMessage' class="form-control" placeholder="Message associé au lien de l'évènement..." />
                            </div>
