    ...
    <div className='page'>
      {
        <div className='mb-5'>
          <div className='flex flex-wrap items-center justify-between '>
            <span className='m-3'>{contacts.length} Messages</span>
            ...
            <tbody>
              {
                filteredContact.sort((a, b) => {
                  ...
                  >
                    ...
                    <td>
                      <button onClick={() => deleteContact(contact._id)} className="m-2 h-[40px] w-[40px] flex justify-center items-center bg-[red] hover:bg-red-400 rounded-1 text-[white]">
